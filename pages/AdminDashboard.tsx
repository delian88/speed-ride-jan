...
import { 
  ...
  BarChart3, Menu, Save, Trash2, ShieldCheck, Filter, ArrowUpRight, Clock,
  MapPin, Navigation, Info, ShieldAlert, CreditCard
} from 'lucide-react';
import { 
...
const SettingsView: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl space-y-8 animate-in slide-in-from-bottom-8 duration-500">
